...
SECRET_KEY = 'django-insecure-$7b-^&3b5au&qea=j2kipo_z#%l6$v%b6_&cadp+i!v40gfi^l'
...
MEDIA_ROOT = DB_CONFIG.get('projects', {}).get('healthcare', {}).get('media_dir', 'healthcare_media')
